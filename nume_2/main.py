...
p_ini, T_ini = [3.005685699294E1, 3.001439346529E1], [193.5, 196.5]
...
sib = time() - sct
sct0 = time()
tc0, cc0, ttem0, ptem20, tem20 = run_tough(f'{ff}/treact2', times['total'], fl0, ch0, 'd', p_ini, T_ini, 2)
sib0 = time() - sct0
print(f'forward model run 1 for {sib} seconds')
print(f'forward model run 2 for {sib0} seconds')
write_string('next.txt', 'a', f'\ttime={sib}\tDFN time={sib0}')
...
print(f'temperature error={rr_T}')
print(f'maximum temperature error={max_T}')
plt.legend()
plt.ylim(75.0, 200.0)
